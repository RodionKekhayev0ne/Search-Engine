...
public class Main {
    ...
    private static Logger logger = LogManager.getLogger("Exceptions");;


    private static final String DATA_FILE = "C:\\Users\\L0veL1v3\\Desktop\\java_basics\\12_ExceptionsDebuggingAndTesting\\homework_12.2\\SPBMetro\\src\\main\\resources\\map.json";
    ...
    private static void parseConnections(JSONArray connectionsArray) {
        connectionsArray.forEach(connectionObject ->
        {
            ...
            connection.forEach(item ->
            {
                ...
                if (station == null) {
                    logger.error( stationName + " on line " + lineNumber + " not found");
